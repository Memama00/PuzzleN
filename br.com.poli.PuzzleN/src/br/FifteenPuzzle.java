...
public class FifteenPuzzle {
	 ...
	 * @return
	 */
	public FifteenPuzzle moveClone(Point p) {
	...
	public List<FifteenPuzzle> aStarSolve() {
		...
		PriorityQueue<FifteenPuzzle> toVisit = new PriorityQueue<FifteenPuzzle>(100000, comparator);
	...
	public static void main(String[] args) {
		...
		p.shuffle(100); // Number of shuffles is critical -- large numbers (100+) and 4x4 puzzle is hard
						// even for A*.
